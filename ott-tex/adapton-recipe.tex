...
\begin{array}{lc}
  {\scalebox{1.5}{
  \boxed{[[Graph1; Path; Moment; Space |- e !! Graph2; v]]}}}
&
\begin{array}{p{4in}}
  ``
  ...
  and moment~$[[Moment]]$,\\
  \hspace{3mm}~expression~$[[e]]$ evaluates fully,\\
  \hspace{6mm}~resulting in graph~$[[Graph2]]$ and value~$[[v]]$.
  ''
\end{array}
\end{array}
\]
...
\item[(1)] $\begin{array}[t]{lcl}
  [[Graph1; Path; Moment; Space |- e !! Graph2; v]]
  & \Rightarrow &
  \exists
      [[Store1]], [[Store2]].~~
      [[Store1 ~~ Graph1]]
...
\item[(2)] $\begin{array}[t]{lcl}
  ...
  \exists
      ...
      %\\
      %&&
  ~~\bigwedge~~ [[Graph1; Path; Moment; Space |- e !! Graph2; v ]]
  \end{array}$
\end{itemize}
