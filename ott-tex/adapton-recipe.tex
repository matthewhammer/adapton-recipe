...
\begin{figure}
  \begin{center}
  \input{mergeSort-inputSeqBig}
  % todo -- input an image of the original sequence, as a linked list
  \end{center}
  \caption{\texttt{mergeSort} ``big'' input sequence, as a harmonious tree.}
\end{figure}
...
\lstinputlisting[language=Fumola, style=Fumola, caption={Sequence Tree Generation}, label={lst:seq-tree-gen}]{../examples/SeqTree.fumola}
