...
\lstdefinelanguage{Fumola}{
  morekeywords={switch,case,public,func,thunk,if,else,let,put,get,force,do,type,module},
  literate=
...
\lstdefinestyle{Fumola}{
  language=Fumola,
  basicstyle=\fontsize{8.5}{10.2}\selectfont\ttfamily,
...
\newcommand{\SeqTreeBinaryNode}[2]{\begin{tabular}{c}#1\\--\end{tabular}}
\newcommand{\SeqTreeElement}[2]{\begin{tabular}{c}#1\\#2\end{tabular}}
