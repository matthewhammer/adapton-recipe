...
The local trace~$[[t]]$ of each node gives a local ordering to the edges whose source is that node.
...
\paragraph{Partial cleaning and misaligned traces.}
The judgement~$[[Graph1; Path; Moment; m; Space |- misaligned(t) !!
