...
The judgement that defines the reference semantics can be implemented by an interpreter with five inputs, and two outputs (other than dynamic errors, due to violating the abstract semantics):
